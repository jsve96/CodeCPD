...
Dataset_path = os.path.join(current_directory,"datasets","bee_waggle_6.json")
...
annotations = META_ANNOTATIONS['bee_waggle_6']
...
np.random.seed(10)
SWATCH = p_Detector(mat,K=7,eps=1.2,kappa=2,mu=8,L=100,p=2,fimp=True)
cps = SWATCH.run()
print(annotations)
print(cps)
