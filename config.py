...
DATASETS = ['run_log']#['MNIST_C3_'+str(i) for i in range(10)]#['subject'+str(i)+"_HAR" for i in range(1,31)]#['Libras']#['MNIST_1','MNIST_2','MNIST_3','MNIST_4','MNIST_5','MNIST_6','MNIST_7','MNIST_8','MNIST_9']#['batch6']#,'batch6']#['bee_waggle_6', 'occupancy','run_log']#['MNIST_0','MNIST_1','MNIST_2','MNIST_3','MNIST_4','MNIST_5','MNIST_6','MNIST_7','MNIST_8','MNIST_9']
